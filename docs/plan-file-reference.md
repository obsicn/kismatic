...
###  cluster.admin_password _(deprecated)_
 ...
 The password for the admin user. This is mainly used to access the Kubernetes Dashboard. For new installations this will not be used. This field will be removed completely in a future release. 
