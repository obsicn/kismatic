...
| Kubernetes Node | `sudo yum -y install --setopt=obsoletes=0 docker-ce-17.03.2.ce-1.el7.centos && yum -y install nfs-utils kubelet-1.8.3-0 kubectl-1.8.3-0` |
...
| Kubernetes Node | `sudo apt-get install -y docker-ce=17.03.2~ce-0~ubuntu-xenial nfs-common kubelet=1.8.3-00 kubectl=1.8.3-00` |
